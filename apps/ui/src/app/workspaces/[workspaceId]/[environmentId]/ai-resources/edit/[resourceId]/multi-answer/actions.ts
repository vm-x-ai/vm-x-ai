...
import {
  ...
  type FormAction,
  schema,
} from '@/components/AIResources/Form/Edit/SecondaryModels';
...
export async function submitForm(
  ...
  revalidatePath(
    `/workspaces/${prevState.pathParams.workspaceId}/${prevState.pathParams.environmentId}/ai-resources/edit/${prevState.pathParams.resourceId}/multi-answer`
  );
