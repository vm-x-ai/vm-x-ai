...
import AIResourceFallbackEditForm from '@/components/AIResources/Form/Edit/Fallback';
...
export const metadata = {
  title: 'VM-X AI Console - Edit AI Resource - Fallback',
  description: 'VM-X AI Console - Edit AI Resource - Fallback',
};
