...
export default async function Layout({ children, params }: LayoutProps) {
  ...
  const tabs = [
    {
      path: `/${workspaceId}/${environmentId}/ai-connections/edit/${connectionId}/general`,
      name: 'General Settings',
    },
    {
      path: `/${workspaceId}/${environmentId}/ai-connections/edit/${connectionId}/provider`,
      name: 'Provider',
    },
    {
      path: `/${workspaceId}/${environmentId}/ai-connections/edit/${connectionId}/capacity`,
      name: 'Capacity',
    },
  ];
