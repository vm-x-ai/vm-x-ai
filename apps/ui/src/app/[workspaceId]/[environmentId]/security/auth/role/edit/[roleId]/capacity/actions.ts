...
import { CapacityEntity, updateApiKey } from '@/clients/api';
import {
  type FormSchema,
  type FormAction,
  schema,
} from '@/components/Auth/APIKeys/Form/Edit/Capacity';
...
export async function submitForm(
  ...
  revalidatePath(
    `/${prevState.pathParams.workspaceId}/${prevState.pathParams.environmentId}/security/auth/role/overview`
  );
