...
export default {
  ...
  overrides: {
    columns: {
      ...
      'ai_connections.capacity':
        'ColumnType<any[] | null, string | null, string | null>',
      'ai_connections.discovered_capacity':
        'ColumnType<any | null, string | null, string | null>',
      'ai_connections.config':
        'ColumnType<any | null, string | null, string | null>',

      // AI Resources
      'ai_resources.model': 'ColumnType<any, string, string | null>',
      'ai_resources.routing':
        'ColumnType<any | null, string | null, string | null>',
      'ai_resources.secondary_models':
        'ColumnType<any[] | null, string | null, string | null>',
      'ai_resources.fallback_models':
        'ColumnType<any[] | null, string | null, string | null>',
      'ai_resources.capacity':
        'ColumnType<any[] | null, string | null, string | null>',
      ...
      // Completion Audit
      'completion_audit.events':
        'ColumnType<any[] | null, string | null, string | null>',
      'completion_audit.request_payload':
        'ColumnType<any | null, string | null, string | null>',
      'completion_audit.response_data':
        'ColumnType<any | null, string | null, string | null>',
      ...
      'completion_batch.callback_options':
        'ColumnType<any | null, string | null, string | null>',
      'completion_batch.capacity':
        'ColumnType<any[] | null, string | null, string | null>',

      // Completion Batch Items
      'completion_batch_items.request':
        'ColumnType<any | null, string | null, string | null>',
      'completion_batch_items.response':
        'ColumnType<any | null, string | null, string | null>',
